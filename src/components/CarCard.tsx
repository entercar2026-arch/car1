...
Description: ${formattedDesc}`;
  ...
  const facebookShareLink = useMemo(() => {
    // Facebook sharer handles webpages best. Direct MP4 links or images often fail to load previews.
