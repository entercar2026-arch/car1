              ...
              onClick={(e) => {
                ...
                if (navigator.share) {
                  navigator.share({
                    ...
                    text: shareText,
                    url: car.videoUrl || window.location.href,
                  }).catch(console.error);
                } else {
                  navigator.clipboard.writeText(`${shareText}\n\n${car.videoUrl || window.location.href}`);
