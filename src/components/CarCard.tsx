...
Description: ${formattedDesc}`;
    ...
    if (videoLink) {
      return `https://wa.me/?text=${encodeURIComponent(`${videoLink}\n\n${cleanText}`)}`;
    } else {
      return `https://wa.me/?text=${encodeURIComponent(`${cleanText}\n\n${window.location.href}`)}`;
    }
  }, [car.name, car.price, car.description, effectiveVideoUrl]);
              ...
              onClick={(e) => {
                ...
                if (navigator.share) {
                  navigator.share({
                    ...
                    text: shareText,
                    url: effectiveVideoUrl || window.location.href,
                  }).catch(console.error);
                } else {
                  navigator.clipboard.writeText(`${shareText}\n\n${effectiveVideoUrl || window.location.href}`);
