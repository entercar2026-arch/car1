                ...
                <div className="flex justify-between items-center mb-2 w-full min-h-[28px] gap-2 relative">
                  ...
                  <div className="flex items-center gap-1.5 shrink-0 ml-auto">
                    ...
                    <a
                      ...
                      className="w-8 h-8 flex items-center justify-center rounded-full bg-[#25D366]/5 hover:bg-[#25D366]/10 transition-colors border border-[#25D366]/20 cursor-pointer shadow-xs text-[#25D366]"
                      title="Share on WhatsApp"
                    >
                      <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path d="M12.012 0C5.385 0 0 5.385 0 12.012c0 2.12.551 4.148 1.558 5.952L.113 24l6.196-1.624c1.748.91 3.7 1.391 5.703 1.391 6.626 0 12.011-5.385 12.011-12.012C24.023 5.385 18.638 0 12.012 0zm0 21.737c-1.782 0-3.518-.48-5.034-1.385l-.36-.214-3.74.981.996-3.648-.235-.373a9.985 9.985 0 0 1-1.528-5.35c0-5.508 4.48-9.988 9.99-9.988 5.508 0 9.988 4.48 9.988 9.988 0 5.51-4.48 9.989-9.988 9.989zm5.485-7.493c-.302-.152-1.782-.88-2.057-.98-.276-.1-4.78 0-.478-.152-.201-.301-.88 1.13-1.082 1.332-.202.201-.403.226-.705.076-.302-.152-1.272-.47-2.424-1.498-.897-.798-1.503-1.784-1.68-2.086-.176-.302-.018-.466.133-.617.136-.135.302-.352.453-.528.152-.176.202-.302.302-.503.1-.202.05-.377-.025-.528-.076-.152-.678-1.636-.93-2.24-.244-.59-.492-.51-.677-.52-.175-.01-.377-.01-.579-.01-.202 0-.528.076-.805.378-.277.302-1.057 1.03-1.057 2.515 0 1.484 1.082 2.918 1.233 3.12.152.2 2.128 3.25 5.158 4.555.72.31 1.282.495 1.722.634.722.228 1.382.196 1.902.118.58-.086 1.782-.728 2.033-1.43.251-.703.251-1.306.176-1.43-.075-.125-.276-.2-.578-.35z"/>
                      </svg>
                    </a>
                  </div>
                </div>
