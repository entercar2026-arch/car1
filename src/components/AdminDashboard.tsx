                          ...
                          <div className="flex flex-col gap-1.5">
                            ...
                            <div className="flex gap-2 mt-1">
                              <button
                                ...
                                className="flex-1 py-2 px-3 text-[10px] font-extrabold text-white bg-[#4C0027] hover:bg-[#36001a] transition-all rounded-lg select-none cursor-pointer flex items-center justify-center gap-1"
                              >
                              ...
                              <button
                                ...
                                className="py-2 px-3 text-[10px] font-bold text-stone-700 bg-stone-100 hover:bg-stone-200 transition-all rounded-lg select-none cursor-pointer"
                              ...
                              {formThumbnail ? (
                                <div className="relative border border-stone-200 rounded-xl overflow-hidden bg-stone-100 h-36">
                                  ...
                                  <button
                                    ...
                                    className="absolute top-2 right-2 bg-stone-900/80 hover:bg-black text-white w-6 h-6 rounded-full flex items-center justify-center font-bold text-sm transition-all shadow-md cursor-pointer select-none"
