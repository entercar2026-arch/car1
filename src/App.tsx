        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 select-none">
          <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2.5 text-xs text-stone-400">
                <li>
                  <button onClick={() => { scrollToAnchor("catalog-section"); setFilters(prev => ({ ...prev, brand: 'Toyota' })); }} className="hover:text-amber-300 transition-colors cursor-pointer text-left font-semibold flex items-center group">
                ...
                <li>
                  <button onClick={() => { scrollToAnchor("catalog-section"); setFilters(prev => ({ ...prev, brand: 'Lexus' })); }} className="hover:text-amber-300 transition-colors cursor-pointer text-left font-semibold flex items-center group">
                ...
                <li>
                  <button onClick={() => { scrollToAnchor("catalog-section"); setFilters(prev => ({ ...prev, brand: 'Ford' })); }} className="hover:text-amber-300 transition-colors cursor-pointer text-left font-semibold flex items-center group">
                ...
                <li>
                  <button onClick={() => { scrollToAnchor("catalog-section"); setFilters(prev => ({ ...prev, brand: 'MG' })); }} className="hover:text-amber-300 transition-colors cursor-pointer text-left font-semibold flex items-center group">
                ...
                <li>
                  <button onClick={() => { scrollToAnchor("catalog-section"); setFilters(prev => ({ ...prev, brand: 'Nissan' })); }} className="hover:text-amber-300 transition-colors cursor-pointer text-left font-semibold flex items-center group">
                ...
                <li>
                  <button onClick={() => { scrollToAnchor("catalog-section"); setFilters(prev => ({ ...prev, brand: 'Mazda' })); }} className="hover:text-amber-300 transition-colors cursor-pointer text-left font-semibold flex items-center group">
